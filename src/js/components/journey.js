...
class Journey extends React.Component {
  ...
  componentDidMount(){
    ...
    let str = `<p>Nicholas Glover, a lover of video games, computers, maps, and now Front-End Engineering.
              Is now continuing his journey into the realm of the unknown.
              Never accepting the what has been told to him to be the absolute truth in the pursuit of knowledge!
              ...
              but that statement would be far from the truth. Through hard work,
              and great teachers Mr. Glover was able to obtain the education he needed.
            </p>

            <p>When he was a teenager he was able to learn how to work on and build PCs through the help of an older gentlemen who owned a computer store.
              In college he learned the importance of programming while obtaining his degree to become a GIS professional.
              He would continue to learn it’s great benifits as he worked for the City of Cookeville.
              Over the next few years at this job made his yearning to know how to program grow.
            <p>

            <p>
              As seasons change so do people. A time of great change had befallen upon Mr. Glover. One that would change many aspects of his life.
              ...
              What adventures await him now? You may be the one to guide him to the next Journey!
            </p>
            <p>
